...
export const CardProcesoCarga = ({ onBorrar, procesos }) => {
  ...
  const handleActivar = () => {
    ...
    fetch(`http://localhost:8081/procesoCarga-actualizar/${procesos.id}`, {
      method: 'PUT',
      headers: {
  ...
  const fechaFin = new Date(fechainicioII).toISOString().split("T")[0];
  return (
    <>
